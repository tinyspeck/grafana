...
func init() {
	metricsMap = map[string][]string{
		...
		"AWS/ApplicationELB": { "ActiveConnectionCount", "ClientTLSNegotiationErrorCount", "ConsumedLBCapacityUnits", "HTTPCode_ELB_4XX_Count", "HTTPCode_ELB_5XX_Count", "HTTPCode_Target_2XX_Count", "HTTPCode_Target_4XX_Count", "NewConnectionCount", "ProcessedBytes", "RequestCount", "TargetResponseTime"},
